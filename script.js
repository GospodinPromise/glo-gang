...
const targetMonthValue = document.querySelector('.target_month-value');
    ...
    obyazRashodiSum.addEventListener('change', function(){ expensesMonthValue.value = obyazRashodiSum.value });

    vozmozhniDohodi[0].addEventListener('change', function() { additionalIncomeValue.value = vozmozhniDohodi[0].value + ' ' + vozmozhniDohodi[1].value + ' ' + dopDohodName.value });
    vozmozhniDohodi[1].addEventListener('change', function() { additionalIncomeValue.value = vozmozhniDohodi[0].value + ' ' + vozmozhniDohodi[1].value + ' ' + dopDohodName.value });
    dopDohodName.addEventListener('change', function() { additionalIncomeValue.value = vozmozhniDohodi[0].value + ' ' + vozmozhniDohodi[1].value + ' ' + dopDohodName.value });

    vozmozhniRashodi.addEventListener('change', function() { additionalExpensesValue.value = vozmozhniRashodi.value.replaceAll(',',' ')});
